...
public class PointInPolyhedron : MonoBehaviour
{
    ...
    public bool IsPointInside(Vector3 point)
    {
        ...
        // 삼각형 분할 및 레이 교차 검사
        foreach (var triangle in Triangulate())
        {
    ...
    private Vector3[][] Triangulate()
    {
        ...
        for (int i = 0; i < chunk.triangles.Count; i += 3)
        {
            ...
            {
            chunk.vertices[chunk.triangles[i]],
            chunk.vertices[chunk.triangles[i + 1]],
            chunk.vertices[chunk.triangles[i + 2]]
            };
